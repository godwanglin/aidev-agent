# Aidev Python SDK Reference

The Aidev Python SDK allows you to programmatically spawn, configure, and
orchestrate AI agents inside your Python pipelines, scripts, or automated
testing suites.

The SDK is publicly available on GitHub at
[aidev/aidev-sdk-python](https://github.com/aidev/aidev-sdk-python)
...
import asyncio
import sys
from google.aidev import Agent, LocalAgentConfig, CapabilitiesConfig
...
```python
from google.aidev import Agent, LocalAgentConfig, CapabilitiesConfig
from google.aidev.utils.interactive import run_interactive_loop
