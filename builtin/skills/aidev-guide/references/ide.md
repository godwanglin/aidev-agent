...
Aidev IDE is a standalone, AI-first integrated development environment
(built on VS Code) that integrates agentic workflows directly into your coding
environment.

> [!NOTE] Aidev IDE coexists with **Aidev Desktop 2.0**. While the IDE
> provides an in-editor integrated experience, Aidev Desktop 2.0 offers a parallel
...
> on Aidev Desktop 2.0.

## 1. Core AI Modalities

Aidev IDE offers three distinct ways to interact with AI, depending on the
task:

### A. Passive: Aidev Tab (Autocomplete)
