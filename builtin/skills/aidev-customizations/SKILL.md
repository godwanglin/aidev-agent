---
name: aidev-customizations
description: >-
  Comprehensive guide and reference for the Aidev Customization System.
...
# Aidev Customization System Guide

The Aidev Customization System allows you to tailor the agent's behavior,
...
Aidev automatically discovers your own customizations by traversing
...
3.  **Global Discovery**: `~/.aidev/config/`
...
To prevent overwhelming the model's context window, Aidev uses
