...
Aidev, configuring MCP servers allows you to expose custom tools,
...
*   **Global Configuration**: `~/.aidev/config/mcp_config.json` (applies to all
    sessions).
...
Aidev supports two transport mechanisms for MCP: **Stdio** (for local
