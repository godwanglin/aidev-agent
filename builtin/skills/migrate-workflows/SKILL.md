...
1.  **Global Workflows**:
    ...
    -   `~/.aidev/config/global_workflows/*.md`
    -   `~/.aidev/config/workflows/*.md`
    -   Manifests: `~/.aidev/config/workflows.json`
...
> - When presenting tables, progress, or summaries to the user, **always format paths using the host OS path separators** (e.g. `\` on Windows such as `%USERPROFILE%\.aidev\config\global_workflows\<name>.md`, `/` on macOS/Linux).
...
:-------- | :------------ | :-------------------------------------------- | :------------------------------------------- | :-----
Global    | `<name>`      | `~/.aidev/config/global_workflows/<name>.md` | `~/.aidev/config/skills/<name>/SKILL.md`    | `Pending` / `Already Migrated`
Global    | `<name>`      | `~/.aidev/config/workflows/<name>.md`        | `~/.aidev/config/skills/<name>/SKILL.md`    | `Pending` / `Already Migrated`
